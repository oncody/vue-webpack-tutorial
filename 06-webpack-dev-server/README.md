# In this tutorial you'll learn how to use webpack-dev-server which both bundles your code and its dependencies together and serves your web application in one seamless step
